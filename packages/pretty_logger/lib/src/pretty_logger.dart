...
PrettyLogger get logger => Zone.current[_loggerKey] as PrettyLogger? ?? _logger;
...
/// to the callback.
void runWithLogger<T>(PrettyLogger logger, T Function() callback) {
  runZoned(
    callback,
...
const _loggerKey = 'logger.pretty_logger';
...
class DefaultLogger extends PrettyLogger {
