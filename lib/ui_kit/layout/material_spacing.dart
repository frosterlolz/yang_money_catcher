...
class HorizontalSpacing extends EdgeInsets {
  ...
  /// Horizontal spacing for small window size.
  const HorizontalSpacing.small() : this._(12);

  /// Horizontal spacing for compact window size.
  const HorizontalSpacing.compact() : this._(16);

  /// Horizontal spacing for medium+ window size.
